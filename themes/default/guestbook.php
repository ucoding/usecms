    ...
    <div class="formsub">
        <form action="__APP__/form/post" method="post">
            ...
            <div class="guest_post">
                ...
                <div class="subdiv"><img src="__APP__/form/verify" alt="如果您无法识别验证码，请点图片更换" width="50" height="25"
                                         border="0" align="top" id="verifyImg" style="margin-left:3px;"
                                         onClick="fleshVerify()"/>&nbsp;
                    <input style="width:50px;" name="checkcode" type="text" class="guest_post_text" id="checkcode">
