...
insert  into `dc_admin`(`id`,`gid`,`user`,`password`,`nicename`,`regtime`,`logintime`,`ip`,`status`,`loginnum`,`keep`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','admin',1350138971,1368157636,'127.0.0.1',1,99,1),(2,2,'user','e10adc3949ba59abbe56e057f20f883e','user',1368092341,1368173391,'127.0.0.1',1,12,0);
...
insert  into `dc_admin_log`(`id`,`uid`,`time`,`ip`) values (1,2,1368173391,'127.0.0.1');
