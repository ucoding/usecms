...
insert  into `dc_admin`(`id`,`gid`,`user`,`password`,`nicename`,`regtime`,`logintime`,`ip`,`status`,`loginnum`,`keep`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','admin',1350138971,1368157636,'127.0.0.1',1,99,1),(2,2,'user','e10adc3949ba59abbe56e057f20f883e','user',1368092341,1368123457,'127.0.0.1',1,11,0);
...
insert  into `dc_admin_group`(`id`,`name`,`model_power`,`class_power`,`status_power`,`grade`,`keep`) values (1,'超级管理员','1,4,11,27,2,3,21,22,23,6,12,14,15,234,9,5,26,29,16,30,24,28','',0,1,1),(2,'普通用户','2,3,22,6,12,14,15,16,9,5','',0,3,0);
...
insert  into `dc_admin_menu`(`id`,`pid`,`name`,`module`,`status`) values (2,0,'内容','content',1),(5,9,'站点基本信息','setting',1),(11,30,'栏目类型管理','model_manage',1),(6,0,'其他','expand',1),(27,30,'扩展模型','expand_model',1),(12,6,'自定义变量','fragment',1),(236,30,'设置','dev_setting',1),(14,6,'TAG管理','tags',1),(15,6,'广告位管理','position',1),(16,29,'附件管理','upload_file',1),(21,3,'角色管理','user_group',1),(22,3,'管理员管理','user',1),(23,3,'后台登录记录','log',1),(24,30,'插件管理','plugin',1),(26,9,'语言管理','lang',1),(1,0,'栏目','category',1),(4,1,'栏目管理','category',1),(28,30,'表单管理','form',1),(9,0,'设置','setting',1),(3,0,'用户','user',1),(29,0,'附件','upload_file',1),(234,6,'站点地图','sitemap',0),(30,0,'开发','dev',1);
...
insert  into `dc_form_data_guestbook`(`id`,`name`,`email`,`content`,`time`,`http`,`reply`,`status`) values (3,'2','2','222',1368164075,NULL,NULL,0);
...
insert  into `dc_plugin`(`id`,`name`,`file`,`status`,`mid`,`ver`,`author`) values (1,'站点地图','sitemap',0,234,1,'duxcms');
...
insert  into `dc_position_relation`(`aid`,`pid`) values (43,4),(45,3),(11,3),(13,3),(16,3),(17,3),(18,3),(18,1),(8,1),(6,1),(2,1),(4,1),(14,1),(5,4),(3,1);
...
insert  into `dc_tags`(`id`,`name`,`click`) values (1,'小米',1),(2,'用户',1),(3,'三星',1),(4,'行货报价',1),(5,'分辨率',1),(6,'代言人',1),(7,'巨人网络',1),(8,'资料图片',1),(9,'史玉柱',1),(10,'新京报',1),(11,'价格波动',1),(12,'iPhone4',1),(13,'iPhone5',1),(14,'董事长',1),(15,'年轻人',1),(16,'留学生',1),(17,'地',1),(18,'巴基斯坦',1),(19,'外国人',1),(20,'小伙子',1),(28,'博物馆',1),(29,'浙江省长',1),(30,'浙江诸暨',1),(31,'吕祖善',1),(32,'菲律宾',1),(33,'地震',1),(34,'地质勘探局',1),(35,'奥地利',1),(36,'太平洋地区',1),(37,'研究报告',1),(38,'生物灭绝',1),(39,'婴儿游泳馆',1),(40,'天河区',1),(41,'电影',1),(42,'辽宁省',1),(43,'知识',1),(44,'主演',1),(45,'AngelaBaby',1),(46,'蔡卓妍',1),(47,'空调',1),(48,'消费者',1),(49,'智能电视',1),(50,'频道',1),(51,'佳能',1),(52,'处理器',1),(55,'感光度',1),(56,'照片',1),(57,'如何',1);
...
insert  into `dc_upload`(`id`,`file`,`title`,`folder`,`ext`,`size`,`type`,`time`) values (13,'/duxcms/upload/2013-05/10/QQjietu20130508143420.png','QQ截图20130508143420','2013-05-10','png',68252,NULL,1368155107),(12,'/duxcms/upload/2013-05/10/QQjietu20130428154435.png','QQ截图20130428154435','2013-05-10','png',25052,NULL,1368155107),(11,'/duxcms/upload/2013-05/10/QQjietu20130423115523.png','QQ截图20130423115523','2013-05-10','png',28833,NULL,1368155107),(10,'/duxcms/upload/2013-05/10/IAATshouye.jpg','IAAT首页','2013-05-10','jpg',450020,NULL,1368155106),(9,'/duxcms/upload/2013-05/10/fucking.png','fucking','2013-05-10','png',132588,'category',1368155022),(14,'/duxcms/upload/2013-05/10/QQjietu20130508143420-a8a45.png','QQ截图20130508143420','2013-05-10','png',68252,NULL,1368155156);
