...
insert  into `dc_admin`(`id`,`gid`,`user`,`password`,`nicename`,`regtime`,`logintime`,`ip`,`status`,`loginnum`,`keep`) values (1,1,'admin','21232f297a57a5a743894a0e4a801fc3','admin',1350138971,1368103004,'127.0.0.1',1,92,1),(2,2,'user','e10adc3949ba59abbe56e057f20f883e','user',1368092341,1368103023,'127.0.0.1',1,9,0);
...
insert  into `dc_admin_group`(`id`,`name`,`model_power`,`class_power`,`status_power`,`grade`,`keep`) values (1,'超级管理员','','',0,1,1),(2,'普通用户','2,3,22,6,12,14,15,16,9,5','',0,3,0);
