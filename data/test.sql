...
INSERT INTO `dc_admin_group` (`id`, `name`, `model_power`, `class_power`, `grade`, `keep`) VALUES
(1, '超级管理组', '', '', 1, 1);
...
(3, 1, '产品图片', 'listpic', 5, 1, 250, 0, NULL, 0, NULL, 0, NULL);
...
INSERT INTO `dc_form` (`id`, `name`, `table`, `display`, `page`, `tpl`, `alone_tpl`, `order`, `where`) VALUES
(2, '留言板', 'guestbook', 1, 10, 'guestbook.html', 0, 'id desc', 'status=1');
...
INSERT INTO `dc_form_data_guestbook` (`id`, `name`, `email`, `content`, `time`, `http`, `reply`, `status`) VALUES
(1, 'duxcms', '244328880@QQ.COM', '欢迎使用duxcms网站内容管理系统', 1363144151, '', '', 1);
