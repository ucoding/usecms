<div class="page_function">
    <div class="info">
        <h3>内容替换添加</h3>
        <small>使用以下功能进行内容替换添加操作</small>
    </div>
</div>
<div class="tab" id="tab">
    <a class="selected" href="#">添加内容替换</a>
        ...
        <div class="page_table form_table">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td width="300">
                        <input name="key" type="text" class="text_value" id="key" value="" reg="\S" msg="内容替换名称不能为空"/>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="num" type="text" class="text_value" id="num" reg="[0-9]" msg="替换次数只能为数字"/>
                    </td>
                    <td></td>
                </tr>
