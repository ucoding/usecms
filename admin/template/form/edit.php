        ...
        <div class="page_table form_table">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        <input name="table" type="text" class="text_value" id="table" value="{$info.table}"
                               reg="[a-zA-Z0-9_]" msg="表单名只能为英文数字和下划线"/>
                    </td>
                    <td>数据表名</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="page" type="text" class="text_value" id="page" value="{$info.page}" reg="[0-9]"
                               msg="分页数只能为数字"/>
                    </td>
                    <td>前台列表显示的分页数</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="order" type="text" class="text_value" id="order" value="{$info.order}" reg="\S"/>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="where" type="text" class="text_value" id="where" value="{$info.where}"/>
                    </td>
                    <td></td>
                </tr>
